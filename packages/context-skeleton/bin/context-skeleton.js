...
/**
 * ContextSkeleton Standalone CLI Executable
 */

import path from 'path';
import fs from 'fs';
import { skeletonizeDirectory, skeletonize, calculateSavings } from '../src/core.js';
...
if (command === 'badge') {
  ...
  const badgeMd = `[![ContextSkeleton](https://img.shields.io/badge/%E2%9A%A1_ContextSkeleton-67%25_Blended_Savings-00f2fe?style=flat-square)](https://github.com/msgtorahul-art/context-skeleton)\n`;
  const snippet = `⚡ Context optimized by ContextSkeleton (Saved 67% blended context reduction)`;
