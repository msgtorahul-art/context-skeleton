...
## Architecture Rules
- `@context-skeleton/core` MUST NOT rely on external paid APIs or server runtimes. All structural code folding and token estimation must execute 100% locally and offline.
